...
const recipeId = async function() {
    ...
    const fet = await fetch(`https://forkify-api.herokuapp.com/api/v2/recipes/${id}`);
...
<div class="recipe__details">
  <div class="recipe__info">
    ...
    <span class="recipe__info-data recipe__info-data--minutes">${d.cooking_time}</span>
  ...
  <div class="recipe__info">
    ...
    <span class="recipe__info-data recipe__info-data--people">${d.servings}</span>
