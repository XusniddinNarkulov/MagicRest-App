...
const loadRecipe = async function(id) {
    try {
        const json = await Promise.race([
            _helpersJs.getJson(_configJs.API_URL + id),
            timeout(5)
        ]);
...
class RecipeView {
    ...
    <li class="recipe__ingredient">
     ...
     #generatorHTML(d1) {
      ...
      <img src="${d1.image_url}" alt="Tomato" class="recipe__img" />
    ...
    <div class="recipe__details">
      <div class="recipe__info">
        ...
        <span class="recipe__info-data recipe__info-data--minutes">${d1.cooking_time}</span>
      ...
      <div class="recipe__info">
        ...
        <span class="recipe__info-data recipe__info-data--people">${d1.servings}</span>
    ...
    <div class="recipe__ingredients">
      ...
      <ul class="recipe__ingredient-list">
        ${this.#renderIngredients(d1.ingredients).join('')}
      </ul>
    </div>
    ...
    <div class="recipe__directions">
      ...
      <p class="recipe__directions-text">
        ...
        <span class="recipe__publisher">${d1.publisher}</span>. Please check out
